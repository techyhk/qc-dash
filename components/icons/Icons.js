...
const Video = ({ fill, size, width = 24, height = 24, ...props }) => {
    return (
        <svg
            fill="yellow"
            height={size || height}
...
export const icons = {
    ...
    activity: <ActivityIcon fill="var(--nextui-colors-primary)" size={30} />,
    ...
    video: <Video fill="var(--nextui-colors-warning)" size={30} />,
};
